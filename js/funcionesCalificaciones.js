...
function consultarCalificacionTodo() {
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Score/all',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function guardarCalificacion() {
    if ($('#mensajeC').val().trim() == "") {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Score/save',
            data: datosaEnviar,
            type: 'POST',
            dataType: 'json',
...
function traeEditarCalificacion(ide) {
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Score/' + ide,
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function editarCalificacion() {
    if ($('#mensajeC').val().trim() == "") {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Score/update',
            data: datosaEnviar,
            type: 'PUT',
            dataType: 'json',
            contentType: 'application/json',
