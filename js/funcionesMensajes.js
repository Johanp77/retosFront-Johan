...
function consultarMensajeTodo() {
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Message/all',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function traeEditarMensaje(ide) {
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Message/' + ide,
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function editarMensaje() {
    if ($('#mensajeM').val().trim() == "") {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Message/update',
            data: datosaEnviar,
            type: 'PUT',
            dataType: 'json',
...
function guardarMensaje() {
    if ($('#mensajeM').val().trim() == "") {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Message/save',
            data: datosaEnviar,
            type: 'POST',
            dataType: 'json',
            contentType: 'application/json',
