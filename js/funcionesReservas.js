...
function getDataCabana() {
    $.ajax({
        type: 'GET',
        url: 'http://129.151.115.73:8080/api/Cabin/all',
        dataType: 'json',
...
function getDataCliente() {
    $.ajax({
        type: 'GET',
        url: 'http://129.151.115.73:8080/api/Client/all',
        dataType: 'json',
...
function consultarReservaTodo() {
    ...
    let fechaE = "";
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Reservation/all',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function guardarReserva() {
    if ($('#fecha_i').val().trim() == "" || $('#fecha_e').val().trim() == "" || $('#fecha_i').val() > $('#fecha_e').val()) {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Reservation/save',
            data: datosaEnviar,
            type: 'POST',
            dataType: 'json',
...
function traeEditarReserva(ide) {
    ...
    let fechaE = "";
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Reservation/' + ide,
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
...
function editarReserva() {
    if ($('#fecha_i').val().trim() == "" || $('#fecha_e').val().trim() == "" || $('#fecha_i').val() > $('#fecha_e').val()) {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Reservation/update',
            data: datosaEnviar,
            type: 'PUT',
            dataType: 'json',
            contentType: 'application/json',
...
function consultarCantidadReserva() {
    ...
    if ($('#fecha_iR').val().trim() == "" || $('#fecha_fR').val().trim() == "" || $('#fecha_iR').val() > $('#fecha_fR').val()) {
        ...
        $.ajax({
            url: 'http://129.151.115.73:8080/api/Reservation/report-dates/' + fechaI + "/" + fechaE,
            type: 'GET',
            dataType: 'json',
            success: function (respuesta) {
                console.log(respuesta);
...
function consultarCantidadEstados() {
    ...
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Reservation/report-status',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {
            console.log(respuesta)
...
function consultarClienteReserva() {
    ...
    $.ajax({
        url: 'http://129.151.115.73:8080/api/Reservation/report-clients',
        type: 'GET',
        dataType: 'json',
        success: function (respuesta) {            
